      ...
      <main className="container">
        <div className="row mb-2 pt-2 ml-3 d-flex align-items-center justify-content-between">
          ...
          <div className="col-3 p-0 m-0 d-flex align-items-center">
            <img className="img-fluid" src="src-tauri/icons/64x64.png" style={{ width: "2.5em", height: "2.5em" }}/>
            &nbsp;&nbsp;
          ...
          <div className="col-2 d-flex justify-content-center align-items-center">
            <button type="button" id="window-button" className="btn btn-outline-light h-100 w-100">
        ...
        <div className="row my-auto d-flex align-items-center">
          ...
          <div className="col ratio ratio-16x9 flex-column d-grid me-2">
        ...
        <div className="row m-0 mt-2 mb-0">
          <button type="button" id="park-button"
                  className="pt-2 pb-2 btn btn-primary btn-outline-light d-flex align-items-center justify-content-center">

            <span className="display-5 weight-bold">PARKED</span>
            <div>&nbsp;&nbsp;&nbsp;&nbsp;</div>
